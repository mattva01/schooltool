...
class Request(http.Request):
    ...
    def _handleVh(self):
        ...
        have the following form:
          ...
          /++vh++proto:host:port/virtual/path/++/real/path
        ...
        absolute URLs generated by the application will have the form
          ...
          proto://host:port/virtual/path/real/path
        ...
        if self.postpath and self.postpath[0].startswith('++vh++'):
            ...
            try:
                ...
                raise ValueError(_('Too few colons in the '
            ...
            virtual = []
            try:
                while self.postpath[0] != '++':
                    virtual.append(self.postpath.pop(0))
            except IndexError:
                raise ValueError(_("No '++' in path after the "
                                   "virtual hosting directive"))
            self.postpath.pop(0) # '++'
