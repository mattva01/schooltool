...
correct. First let's make sure that all activities are there:
  ...
  {'complete': <ActivityDefinition 'Complete Level'>,
   'enroll': <ActivityDefinition 'Enroll'>,
   'fail': <ActivityDefinition 'Fail'>,
   'graduate': <ActivityDefinition 'Graduate'>,
   'pass': <ActivityDefinition 'Pass'>,
   'withdraw': <ActivityDefinition 'Withdraw'>}
...
defined:
  ...
  [('enroll',
    [<Application 'Write Record': (student, level) --> ()>,
     <Application 'Select Initial Level': () --> (level)>,
     <Application 'Update Status': (student) --> ()>]),
   ('complete',
    [<Application 'Set Level Outcome': () --> (outcome)>]),
   ('graduate',
    [<Application 'Update Status': (student) --> ()>]),
   ('withdraw',
    [<Application 'Update Status': (student) --> ()>,
   ...
   ('pass',
    [<Application 'Write Record': (student, level) --> ()>,
     <Application 'Progress to Next Level': (level) --> (level)>]),
   ('fail',
    [<Application 'Write Record': (student, level) --> ()>])]
...
Next we have a look at the transitions:
  ...
  [TransitionDefinition(from='enroll', to='complete'),
   TransitionDefinition(from='complete', to='pass'),
   TransitionDefinition(from='complete', to='fail'),
   TransitionDefinition(from='complete', to='withdraw'),
   TransitionDefinition(from='pass', to='graduate'),
   TransitionDefinition(from='pass', to='complete'),
   TransitionDefinition(from='fail', to='complete')]
