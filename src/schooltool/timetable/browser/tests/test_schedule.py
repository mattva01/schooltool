...
def doctest_TimetablesTraverser():
    """Tests for TimetablesTraverser.
        ...
        >>> from schooltool.timetable.browser.schedule import TimetablesTraverser
...
def doctest_TimetableView():
    """Test for TimetableView.
        ...
        >>> from schooltool.timetable.browser.schedule import TimetableView
...
def doctest_SectionTimetableSetupView():
    ...
    We can now create the view to look at the Math timetable
        ...
        >>> from schooltool.timetable.browser.schedule import SectionTimetableSetupView
        >>> context = math
        >>> request = TestRequest()
...
def test_suite():
    ...
    suite.addTest(doctest.DocTestSuite('schooltool.timetable.browser',
                                       optionflags=optionflags))
    suite.addTest(doctest.DocTestSuite('schooltool.timetable.browser.schedule',
                                       optionflags=optionflags))
